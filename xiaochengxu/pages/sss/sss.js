...
data:{
  ...
  videosrc:'https://res.chuanying520.com/template/b54681947f3a2849b05f325a0abefc67/sce_prevideo.mp4?v=1575616821'
    ...
    onLoad: function (options) {
      ...
      if (options != null) {
        ...
        var that = this;
        wx.request({
          url: "http://xchone.dagezi888.com:8031/jiekou/Handler1.ashx?bz=tupianlist",
            data: {
                strW: ' where  id=' + options.id,
            ...
            success: function (res) {
              console.log("内容是："+res.data.Data[0]["a2"]);
                ...
                that.setData({
                    title: res.data.Data[0]["a1"],
                    content: res.data.Data[0]["a2"],
                  videosrc: res.data.Data[0]["a5"]
                })
                console.log(that.data.danmuList);
