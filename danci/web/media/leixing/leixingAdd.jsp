...
<script type="text/javascript" src="<%=basePath%>media/leixing/js/leixingAdd.js"></script>
  <jsp:include page="../media.jsp"></jsp:include>
  
  <link rel="stylesheet" href="<%=basePath%>media/leixing/css/bootstrap.min.css" type="text/css"></link>
  	<link rel="stylesheet" href="<%=basePath%>media/leixing/css/uploadify.css" type="text/css"></link>
