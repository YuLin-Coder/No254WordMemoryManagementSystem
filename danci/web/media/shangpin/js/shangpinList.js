...
$(function(){
    ...
    getData();
   	...
   	$("#addbutton").on("click",function(){
   		...
   		window.location.href=getIP()+"media/shangpin/shangpinAdd.jsp";
   	})
    ...
    $("#delbutton").on("click",function(){
    	...
    	if(confirm("确定要删除吗？")){
        	...
        	del.ajax(getIP()+"shangpin.action?delMore",function(data){
        		if(data.success){
    ...
    function getData(){  
	   	...
	   	getPageData(sel,getIP()+"vshangpin.action?list",function(data){
...
function update(id){
	 ...
	 window.location.href=getIP()+"media/shangpin/shangpinModify.jsp?eid="+id;
}
//修改
function jieshu(id){
